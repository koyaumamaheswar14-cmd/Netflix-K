...
public class SendOtpServlet extends HttpServlet {
    ...
    private void sendEmail(String to, String otp) throws MessagingException {
        final String from = "your_email@example.com";         // Replace with your email
        final String password = "your_email_password";        // Replace with your email password or app password

        Properties props = new Properties();
        props.put("mail.smtp.host", "smtp.gmail.com");        // Use your SMTP host
